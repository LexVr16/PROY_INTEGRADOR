...
public class JDMoneda extends javax.swing.JDialog {
    ...
    public JDMoneda(java.awt.Frame parent, boolean modal) {
        ...
        util.start();
        cargarComboPais();
        txt_idMoneda.setText(String.valueOf(Util.generateUniqueId()));
    }
    ...
    void limpiar() {
        ...
        DefaultTableModel model = (DefaultTableModel) jTable_moneda.getModel();
        model.setRowCount(0);
    }
    ...
    private void initComponents() {
        ...
        btn_listarMonedas = new javax.swing.JButton();
        ...
        cbox_simbolo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "< Select >", "S/.", "$.", "€.", "¥.", "£." }));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lbl_fechaHora, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cbox_simbolo, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(txt_tipoCambio, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cbox_simbolo, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jTable_moneda.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombre", "Simbolo", "Tipo de Cambio", "Fecha y Hora", "Pais"
            }
        ));
        ...
        btn_listarMonedas.setText("Listar Monedas");
        btn_listarMonedas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_listarMonedasActionPerformed(evt);
            }
        });
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btn_listarMonedas, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btn_listarMonedas)
                .addGap(15, 15, 15))
        );
    ...
    private void btn_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_actualizarActionPerformed
        ...
        moneda.setId(txt_idMoneda.getText());
        ...
        PaisDaoImp daoImp = new PaisDaoImp();
        moneda.setIdPais(daoImp.getIDPaisByNombre(cbox_pais.getSelectedItem().toString()).getId());
        MonedaController.ActualizarMoneda(moneda);
        MonedaController.cargarMonedasEnLaTabla();
        limpiar();
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        ...
        Moneda moneda  = new Moneda();
        moneda.setId(txt_idMoneda.getText());
        MonedaController.EliminarMoneda(moneda);
        MonedaController.cargarMonedasEnLaTabla();
    ...
    private void btn_registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_registrarActionPerformed
        ...
        MonedaController.RegistraMoneda(moneda);
        MonedaController.cargarMonedasEnLaTabla();
    ...
    private void btn_seleccionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_seleccionarActionPerformed
        ...
        moneda.setId(txt_idMoneda.getText());
        moneda.setNombre(txt_nombre.getText());
        CuentaBancariaController.callJDCuentaBancariaFromMoneda(moneda);
        limpiar();
    ...
    private void jTable_monedaMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_monedaMouseReleased
        txt_idMoneda.setText(jTable_moneda.getValueAt(jTable_moneda.getSelectedRow(), 0).toString());
    ...
    private void btn_listarMonedasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_listarMonedasActionPerformed
        MonedaController.cargarMonedasEnLaTabla();
    }//GEN-LAST:event_btn_listarMonedasActionPerformed
    ...
    private javax.swing.JButton btn_listarMonedas;
    ...
    public javax.swing.JTable jTable_moneda;
